    ...
    <div className="container ">
        ...
        <div className="row align-items-center">
          <div className="col-md-6">
            <img
              src={mission}
              alt="Our Mission"
              className="img-fluid side mb-3"
            />
          </div>
          <div className="col-md-6">
            <h2 className="mb-3">Our Mission</h2>
            <p>
              At PetPooja, our mission is to deliver delicious, high-quality
              meals from the best local restaurants straight to your door. We
              strive to provide a convenient, reliable, and enjoyable food
          ...
          <div className="col-md-6 order-md-1">
            ...
            <ul className="list-group">
              <li className="list-group-item">
                Wide variety of cuisines and dishes to choose from
              </li>
              <li className="list-group-item">
      ...
      <section className="values mb-5">
        ...
        <p className="text-center mb-4">
          We believe in delivering excellence in every meal, ensuring customer
          satisfaction, and supporting our local restaurant partners. Our core
          values include:
        </p>
            ...
            <div className="card value-card text-center">
              ...
              <div className="card-body">
                <p className="card-text">
                  Quality: Providing the best food and service
                </p>
              </div>
            </div>
          </div>

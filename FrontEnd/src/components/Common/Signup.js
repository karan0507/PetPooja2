...
const Signup = () => {
  ...
  const validateStep2 = () => {
    ...
    if (!phone) errors.phone = "Phone number is required";
      ...
      errors.phone = "Enter Valid number(format: xxx-xxx-xxxx)";
    if (role === "Customer") {
      ...
      if (!zipRegex.test(zipcode))
        errors.zipcode = "Enter zip code in A1A 1A1 format";
    }
    if (role === "Merchant") {
      if (!restaurantName)
      ...
      if (!registrationNumber) {
        errors.registrationNumber =
          "Valid restaurant registration number is required";
      } else if (!registrationNumberRegex.test(registrationNumber))
        errors.registrationNumber =
          "Valid restaurant registration number is format X111111111";
      if (!street) errors.street = "Street is required";
      if (!city) errors.city = "City is required";
      if (!province) errors.province = "Province is required";
      if (!zipcode) errors.zipcode = "zip code is required";
